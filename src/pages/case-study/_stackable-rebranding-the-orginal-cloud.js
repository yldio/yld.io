...
import { SectionTitleH2, Paragraph, H6 } from '../../components/Typography'
    ...
    <Layout>
          ...
          <Grid>
            <Row>
              <Col xs={12} sm={12} md={6}>
                <SectionTitleH2>Building from the logo upwards</SectionTitleH2>
              </Col>
              <Col xs={12} sm={12} md={6}>
      ...
      <Grid>
        <Padding top={60} bottom={3}>
          <Row>
            <Col xs={12} sm={12} md={6}>
              <SectionTitleH2>Cutting the wordmark</SectionTitleH2>
            </Col>
            <Col xs={12} sm={12} md={6}>
      ...
      <GreyBackground topMargin topOffset={-232}>
        ...
        <Grid>
          <Padding top={6}>
            <Row>
              <Col xs={12} sm={12} md={6}>
                <SectionTitleH2>Custom typeface</SectionTitleH2>
              </Col>
              <Col xs={12} sm={12} md={6}>
      ...
      <Grid>
        <Padding top={60} bottom={4}>
          <Row>
            <Col xs={12} sm={12} md={6}>
              <SectionTitleH2>New icon system</SectionTitleH2>
            </Col>
            <Col xs={12} sm={12} md={6}>
      ...
      <Grid>
        <Padding bottom={4}>
          <Row>
            <Col xs={12} sm={12} md={6}>
              <SectionTitleH2>Colour approach</SectionTitleH2>
            </Col>
            <Col xs={12} sm={12} md={6}>
      ...
      <GreyBackground topMargin>
        <Grid>
          <Padding top={60} bottom={5}>
            <Row>
              <Col xs={12} sm={12} md={6}>
                <SectionTitleH2>Putting it all together</SectionTitleH2>
              </Col>
              <Col xs={12} sm={12} md={6}>
      ...
      <Padding top={4} bottom={60}>
        <Grid>
          <Row>
            <Col xs={12} sm={12} md={6}>
              <Margin bottom={1}>
                <SectionTitleH2>Product vision</SectionTitleH2>
              </Margin>
